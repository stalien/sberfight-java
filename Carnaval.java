...
public class Carnaval {
     ...
     *
     * Вы купили дорогой билет на карнавал и хотите попасть на все представления. Учитывая время начала мероприятий и длительности
     * проведения, ответьте, возможно ли это. Время перемещения между мероприятиями не учитывается.
     *
     * На входе:
     *
