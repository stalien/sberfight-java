...
public class Premies {
     ...
     *
     * Затем директор решил, что разделение не справедливо, выделил еще сумму s и действовал так: он выбирал конверт с наименьшей суммой и добавлял в него 3$ из
     * этой суммы s до тех пор, пока не исчерпал выделенную сумму s.
     *
